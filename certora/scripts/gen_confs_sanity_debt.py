...
def generate_config(rule_name):
    config = {
        ...
        "verify": "Debt1:certora/specs/sanity/debt.spec"
    }
    
    filename = f"Debt1_{rule_name}_verified.conf"
...
rule_names = [
    ...
    "sanity_siloConfig", "sanity_hookReceiver", "sanity_eip712Domain",
    "sanity_DOMAIN_SEPARATOR", "sanity_decimals", "sanity_totalSupply",
