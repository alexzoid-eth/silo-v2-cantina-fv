...
from silo_split_rule_names import rule_names_ex
...
def generate_config(rule_name, method, fn_name):
    ...
    config = {
        ...
        "verify": "Silo1:certora/specs/silo_split.spec"
    }
    return config
...
for rule in rule_names_ex:
    ...
    for method_sig in silo_methods_hard:
        ...
        full_path = os.path.join("silo_split", filename)
    ...
    full_path_others = os.path.join("silo_split", filename_others)
