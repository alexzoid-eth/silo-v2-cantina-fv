...
def generate_config(rule_name):
    ...
    filename = f"Protected1_{rule_name}_verified.conf"
...
rule_names = [
    "sanity_approve", "sanity_transfer", "sanity_allowance",
    "sanity_silo", "sanity_siloConfig", "sanity_hookReceiver",
    "sanity_eip712Domain", "sanity_DOMAIN_SEPARATOR", "sanity_decimals",
    "sanity_totalSupply", "sanity_hookSetup", "sanity_synchronizeHooks",
    "sanity_balanceOf", "sanity_balanceOfAndTotalSupply",
    "sanity_callOnBehalfOfShareToken", "sanity_initialize",
    "sanity_transferFrom", "sanity_burn", "sanity_forwardTransferFromNoChecks",
    "sanity_mint"
]
