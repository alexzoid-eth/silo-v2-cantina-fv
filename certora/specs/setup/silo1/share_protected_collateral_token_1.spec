...
using ShareProtectedCollateralToken1 as _ShareProtectedCollateralToken1;

methods {
    function _ShareProtectedCollateralToken1.totalSupply() external returns (uint256) envfree;
    function _ShareProtectedCollateralToken1.balanceOf(address account) external returns (uint256) envfree;
    function _ShareProtectedCollateralToken1.allowance(address owner, address spender) external returns (uint256) envfree;

    function _ShareProtectedCollateralToken1.name() external returns (string) => NONDET DELETE;
    function _ShareProtectedCollateralToken1.symbol() external returns (string) => NONDET DELETE;
}
