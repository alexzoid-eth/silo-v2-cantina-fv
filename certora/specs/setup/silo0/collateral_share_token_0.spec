...
methods {
    function _CollateralShareToken0.totalSupply() external returns (uint256) envfree;
    function _CollateralShareToken0.balanceOf(address account) external returns (uint256) envfree;
    function _CollateralShareToken0.allowance(address owner, address spender) external returns (uint256) envfree;

    function _CollateralShareToken0.name() external returns (string) => NONDET DELETE;
    function _CollateralShareToken0.symbol() external returns (string) => NONDET DELETE;
}
