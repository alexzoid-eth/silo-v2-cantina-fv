...
function requireValidStateInvariants(env e) {
    ...
    // ERC20
    requireInvariant erc20TotalSupplySolvency(e);
    ...
    requireInvariant totalTrackedAssetsNotExceedERC20TokenSupply(e);
    requireInvariant protectedSharesMustBeBackedWithAssets(e);
    requireInvariant collateralSharesMustBeBackedWithAssets(e);
    requireInvariant debtSharesMustBeBackedWithAssets(e);
    requireInvariant siloMustNotHaveUserAllowances(e);
}

// ERC20

invariant erc20TotalSupplySolvency(env e)
